<h2>257. Binary Tree Paths</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">root</code> of a binary tree, return <em style="user-select: auto;">all root-to-leaf paths in <strong style="user-select: auto;">any order</strong></em>.</p>
